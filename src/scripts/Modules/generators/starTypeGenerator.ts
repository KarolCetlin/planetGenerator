...
export const numberTypeGenerator = (): void => {
    ...
    currentTypeNumber = Math.floor(Math.random() * availableLifeCycleStars.length);

};

export const starTypeName = (): string => {
    numberTypeGenerator();
    return availableLifeCycleStars[currentTypeNumber]['name'];
};

export const starDescription = (): string => {
    numberTypeGenerator();
    return availableLifeCycleStars[currentTypeNumber]['description'];
};

export const starSpectralType = (): number => {

    let minNumber = availableLifeCycleStars[currentTypeNumber]['minSpectralType'];
    let maxNumber = availableLifeCycleStars[currentTypeNumber]['maxSpectralType'];

    return Math.floor(Math.random() * (maxNumber - minNumber)) + minNumber;
};

export const starSize = (): number => {

    let minNumber = availableLifeCycleStars[currentTypeNumber]['minSize'];
    let maxNumber = availableLifeCycleStars[currentTypeNumber]['maxSize'];
